// src/app/(dashboard)/dashboard/user/layout.tsx
"use client";
...
const navItems = [
  ...
  { label: "Peta UMKM", href: "/user/map", icon: Map },
  { label: "Daftar UMKM", href: "/user/daftar-umkm", icon: Store },
  { label: "Leaderboard", href: "/user/leaderboard", icon: Trophy },
  { label: "Rating Saya", href: "/user/rating", icon: Star },
  { label: "Contact Us", href: "/user/contact", icon: MessageCircle },
];
...
export default function UserDashboardLayout({
  ...
  // Jika di halaman settings, render tanpa sidebar/header (full screen)
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="flex items-center gap-3">
              <div className="text-right">
                <p className="text-sm font-bold text-white leading-tight">Asep Sunandar</p>
